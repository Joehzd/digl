...
public class DialProgress extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        mContext = context;
        mDefaultSize = dipToPx(context, DEFAULT_SIZE);
        mRectF = new RectF();
    ...
    private void initConfig(Context context, AttributeSet attrs) {
        ...
        mValueSize = typedArray.getDimension(R.styleable.DialProgress_valueSize, DEFAULT_VALUE_SIZE);
        ...
        mUnitSize = typedArray.getDimension(R.styleable.DialProgress_unitSize, DEFAULT_UNIT_SIZE);
        ...
        mHintSize = typedArray.getDimension(R.styleable.DialProgress_hintSize, DEFAULT_HINT_SIZE);
